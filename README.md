...
*__Note__*: **It's possible that you can't see images uploaded by users** (*__profile/avatar pictures__* and *__blog photos__*). Once deployed, those images only last few hours. This happens because of Heroku's limits -it's ephemeral filesystem. All dynos are cycled every 24 hours.
